...
moduleForModel('data-line-98dxnnxc-resource-spec-characteristic', 'Unit | Serializer | data-line-98dxnnxc-resource-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-resource-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
