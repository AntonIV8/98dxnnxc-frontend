...
moduleForModel('data-line-98dxnnxc-resource-usage-spec', 'Unit | Serializer | data-line-98dxnnxc-resource-usage-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-resource-usage-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
