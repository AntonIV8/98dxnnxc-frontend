...
moduleForModel('data-line-98dxnnxc-resource-characteristic-log', 'Unit | Serializer | data-line-98dxnnxc-resource-characteristic-log', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-resource-characteristic-log',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
