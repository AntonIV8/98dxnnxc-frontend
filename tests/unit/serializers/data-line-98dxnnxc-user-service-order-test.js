...
moduleForModel('data-line-98dxnnxc-user-service-order', 'Unit | Serializer | data-line-98dxnnxc-user-service-order', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-user-service-order',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
