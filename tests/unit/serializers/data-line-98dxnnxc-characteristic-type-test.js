...
moduleForModel('data-line-98dxnnxc-characteristic-type', 'Unit | Serializer | data-line-98dxnnxc-characteristic-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-characteristic-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
