...
moduleForModel('data-line-98dxnnxc-service-characteristic-log', 'Unit | Serializer | data-line-98dxnnxc-service-characteristic-log', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-service-characteristic-log',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
