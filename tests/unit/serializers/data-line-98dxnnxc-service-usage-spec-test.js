...
moduleForModel('data-line-98dxnnxc-service-usage-spec', 'Unit | Serializer | data-line-98dxnnxc-service-usage-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-service-usage-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
