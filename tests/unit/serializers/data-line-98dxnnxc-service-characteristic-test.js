...
moduleForModel('data-line-98dxnnxc-service-characteristic', 'Unit | Serializer | data-line-98dxnnxc-service-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-service-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
