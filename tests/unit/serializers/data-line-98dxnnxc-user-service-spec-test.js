...
moduleForModel('data-line-98dxnnxc-user-service-spec', 'Unit | Serializer | data-line-98dxnnxc-user-service-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-user-service-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
