...
moduleForModel('data-line-98dxnnxc-user-resource-spec', 'Unit | Serializer | data-line-98dxnnxc-user-resource-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-98dxnnxc-user-resource-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
